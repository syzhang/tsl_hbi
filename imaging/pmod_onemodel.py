"""IO jump freq model pmod with both posterior and kl divergence as pe"""
...
def subjectinfo(subject_id):
    ...
    subject_info = []
    onset_list = []
    condition_names = ['Stim_pp', 'Stim_pe']
    ...
    for r in range(len(runs)):
        onsets = [onset_list[r], onset_list[r+1]]
...
if __name__ == "__main__":
    ...
    # define contrasts
    con_names = ['Stim_ppxpmod_mean^1','Stim_pexpmod_pe^1' ]
    # pmod contrasts
    cont01 = ['pmod_mean', 'T', con_names, [1,0]]
    cont02 = ['pmod_mean_neg', 'T', con_names, [-1,0]]
    cont03 = ['pmod_pe', 'T', con_names, [0,1]]
    cont04 = ['pmod_pe_neg', 'T', con_names, [0,-1]]
